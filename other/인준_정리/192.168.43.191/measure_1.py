...
def sensing_1(percentage_result, lock):
    ...
    while kg_flag:
        ...
        print "total load_1"
        print load1
        print "Percentage weight_1"
        print percentage_weight_1
        '''
...
def sensing_2(percentage_result, lock):
    ...
    while kg_flag:
        ...
        print "total load_2"
        print load2
        print "Percentage weight_2"
        print percentage_weight_2
        '''
...
while True:
    try:
        ...
        lock1.acquire()
        try:
            load1_final_val =  load1_per.value
        finally:
            lock1.release()
        ...
        lock2.acquire()
        try:
            load2_final_val =  load2_per.value
        finally:
            lock2.release()
        ...
        load3_final_val=data[:data.find('p')]
        load4_final_val=data[data.find('p')+1:]
        print "load1 percentage : ", load1_final_val
        print "load2 percentage : ", load2_final_val
        print "load3 percentage : ", load3_final_val
        print "load4 percentage : ", load4_final_val
